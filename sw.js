...
const FILES=['./','./index.html','./styles.css?v=14','./game.js?v=14','./voice-lines.js','./manifest.webmanifest','./assets/glade.png','./assets/observatory.png','./assets/causeway.png','./assets/archive.png','./assets/lantern-court.png','./assets/hall-of-names.png','./assets/palace-atrium.png','./assets/heart-vault.png','./assets/liora.png','./assets/mosswick.png','./assets/sera.png','./assets/elowen.png','./assets/warden.png','./assets/cursor.svg','./assets/moon-icon.svg',...VOICE_FILES];
